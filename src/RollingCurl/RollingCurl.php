<?php
    ...
    class RollingCurl {
         ...
         * @return RollingCurl
         */
        public function request($url, $method = "GET", $postData = NULL, $headers = NULL, $options = NULL, $identifierParams = NULL) {
            $newRequest = new Request($url, $method, $identifierParams);
            if($postData) {
         ...
         * @return RollingCurl
         */
        public function get($url, $headers = NULL, $options = NULL, $identifierParams = NULL) {
            return $this->request($url, "GET", NULL, $headers, $options, $identifierParams);
        }
         ...
         * @return RollingCurl
         */
        public function post($url, $postData = NULL, $headers = NULL, $options = NULL, $identifierParams = NULL) {
            return $this->request($url, "POST", $postData, $headers, $options, $identifierParams);
        }
         ...
         * @return RollingCurl
         */
        public function put($url, $putData = NULL, $headers = NULL, $options = NULL, $identifierParams = NULL) {
            return $this->request($url, "PUT", $putData, $headers, $options, $identifierParams);
        }
         ...
         * @return RollingCurl
         */
        public function delete($url, $headers = NULL, $options = NULL, $identifierParams = NULL) {
            return $this->request($url, "DELETE", NULL, $headers, $options, $identifierParams);
        }
