...
?>
    <h4>Story Gönderme Aracı</h4>
<?php if(is_null($user)) { ?>
    <p>Story gönderme aracı ile, dilediğiniz kullanıcının story paylaşımına, kendi belirlediğiniz adette story görüntülenme gönderebilirsiniz.</p>
    <div class="alert alert-warning"><strong>Dikkat!</strong> Gönderdiğiniz story görüntülenmeleri o kullanıcının yayındaki tüm storylerine gitmektedir.</div>
...
<?php } else { ?>
    <p><strong>Kalan İşlem Hakkınız:</strong> <?php echo $logonPerson->member->gunlukStoryLimitLeft; ?>
    </p>
    <p>
        <strong>İşlem Başına Gönderebileceğiniz Max Story:</strong> <?php echo $logonPerson->member->storyMaxKredi; ?>
    </p>
    <div class="panel panel-default">
        <div class="panel-heading">
            Story Gönder
        ...
        <div class="panel-body">
            <form id="formTakip" class="form">
                ...
                <div class="form-group">
                    ...
                    <span class="help-block">Max <?php echo $logonPerson->member->storyMaxKredi; ?> story görüntülenme gönderebilirsiniz.</span>
                </div>
        ...
        <script type="text/javascript">
            ...
            function sendTakip() {
                ...
                if(isNaN(countTakipMax) || countTakipMax <= 0) {
                    alert('Story Görüntülenme adedi girin!');
                    return false;
                }

                if(countTakipMax > <?php echo $logonPerson->member->storyMaxKredi; ?>) {
                    alert('Story görüntülenme adedi max <?php echo $logonPerson->member->storyMaxKredi; ?> olabilir!');
                    return false;
                }
            ...
            function sendTakipComplete() {
                ...
                $('#userList').prepend('<p class="text-success">Storyleri görüntüleyen toplam kullanıcı adedi: ' + countTakip + '</p>');
            }
        </script>
    <?php }
    $this->endSection(); ?>