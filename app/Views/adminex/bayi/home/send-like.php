...
<?php if(is_null($media)) { ?>
    <p>Beğeni gönderme aracı ile, dilediğiniz gönderiye, kendi belirlediğiniz adette beğeniyi gönderebilirsiniz. Gönderilen beğenilerin tamamı gerçek kullanıcılardır.</p>
