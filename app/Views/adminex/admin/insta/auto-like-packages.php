        ...
        <table class="table table-bordered table-striped">
            ...
            <?php foreach($model as $paket) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo Wow::get("project/adminPrefix"); ?>/insta/user/<?php echo $paket["instaID"]; ?>">@<?php echo $paket["userName"]; ?></a>
                    </td>
                    ...
                    <td>Gönderi Başına Beğeni: <?php echo $paket["likeCountMin"]; ?> - <?php echo $paket["likeCountMax"]; ?><br/>
...
<script type="text/javascript">
    function getLikePackageDetails(id) {
        ...
        $.ajax({url: '<?php echo Wow::get("project/adminPrefix"); ?>/insta/edit-auto-like-package/' + id, type: 'GET'}).done(function(data) {
