    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8 col-md-9">
                <h4 style="margin-top: 0;">Video İzlenme Gönderme Aracı</h4>
                <p>Video izlenme anında gönderilmektedir. Bu sayede siz keşfette yer alıcaksınız Gönderilen video izlenmelerin tamamı gerçek kullanıcılardır.</p>
                <p>Maximum Video krediniz kadar, Video izlenme gönderebilirsiniz!</p>
                <p>Video izlenme göndereceğiniz profil gizli olmamalıdır! Gizli profillerin gönderilerine ulaşılamadığından, beğeni de gönderilememektedir.</p>
				<?php if(is_null($media)) { ?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Video izlenme Gönder
                        </div>
				...
				<?php } elseif($media["items"][0]["user"]["is_private"] == 1) { ?>
                    <hr/>
                    <p class="text-danger">Uppps! Bu gönderiyi paylaşan profil gizli. Gizli profillerin gönderilerine ulaşılamadığından, Video izlenme de gönderilememektedir.</p>
				<?php } else { ?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Video izlenme Gönder
                        ...
                        <div class="panel-body">
                            <form id="formBegeni" class="form">
                                ...
                                <div class="form-group">
                                    <label>Video İzlenme Sayısı:</label>
	...
	if(!is_null($media) && $media["items"][0]["user"]["is_private"] != 1) { ?>
        <script type="text/javascript">
            ...
            function sendBegeniComplete() {
                ...
                $('#userList').prepend('<p class="text-success">Gönderilen toplam etkileşimli video izlenme adedi: ' + countBegeni + '</p>');
            }
        </script>
	<?php }
	$this->endSection(); ?>