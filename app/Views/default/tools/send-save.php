    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8 col-md-9">
                <h4 style="margin-top: 0;">Fotoğraf Kaydetme  Aracı</h4>
                <p>Bu Özellik ile fotoğraflarınıza başkalarına kaydettirebilir bu sayede keşfete düşürebilirsiniz</p>
